...
if __name__ == '__main__':
    ...
    root_path = 'F:\Github\DEFNet\DEFNet-main\DEFNet for RGBT Crowd Counting\RGBT-CC-CVPR2021'  # dataset root path
    save_dir = 'F:\Github\DEFNet\DEFNet-main\DEFNet for RGBT Crowd Counting\RGBT-CC-1'
