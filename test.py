...
parser.add_argument('--data-dir', default='/home/zyjer/RGBT_CC',
                        help='training data directory')
parser.add_argument('--save-dir', default='/home/zyjer/output',
                        help='model directory')
parser.add_argument('--model', default='best_model_36.pth'
                    , help='model name')
